...
// Catálogo de módulos (igual que en ACONFEX)
const MODULOS = [
  {
    slug: "dashboard",
    label: "Dashboard",
...
export default function AdminHome() {
  ...
  return (
    <div className="p-4 md:p-6 bg-[#F8F6F2] min-h-[calc(100vh-64px)]">
      ...
      {/* Grid de aplicaciones - Estilo ACONFEX */}
        ...
        {MODULOS.map((modulo, index) => (
          ...
          >
            ...
            >
              ...
              {/* Descripción */}
              <p className="text-xs text-[#95a5a6] mt-1 line-clamp-2">
                {modulo.desc}
              </p>

              {/* Línea decorativa (como en ACONFEX) */}
