...
export default function ProductosDestacados() {
  ...
  return (
    <section className="py-16 md:py-20 bg-[#556B5D]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-playfair text-3xl md:text-4xl text-[#F8F6F2] mt-1">
            ✦ Nuestros favoritos ✦
          </h2>
          <p className="font-montserrat text-[#F8F6F2]/70 mt-2 max-w-md mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {productosDestacados.map((producto, index) => (
            <motion.div
              ...
              className="bg-[#F8F6F2] rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-4 md:p-6 text-center group cursor-pointer border-t-4 border-[#B89B5E]"
            >
              ...
              <button className="mt-3 w-full bg-[#969E75] text-[#F8F6F2] py-1.5 md:py-2 rounded-full text-xs md:text-sm font-montserrat hover:bg-[#7a8a5e] transition shadow-md hover:shadow-lg">
                Agregar +
              </button>
            </motion.div>
          ))}
